...
# Unraid Management Agent - Project Rules for Augment AI
...
- Reference the official Home Assistant integration development guidelines: https://developers.home-assistant.io/docs/creating_integration_manifest/
...
- `api_client.py`: Unraid API communication
- `websocket_client.py`: Real-time WebSocket updates
- Platform files: Entity implementations for each platform type

## Important Notes
- The integration uses a data coordinator pattern for centralized data management
